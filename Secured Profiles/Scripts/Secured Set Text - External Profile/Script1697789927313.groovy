...
// This will load the 'secured_production_profile' profile from an external folder
String desktopFolder = System.getProperty('user.home') + '/Desktop';
String aProfileOnDesktop = desktopFolder + '/secured_production_profile';
CustomKeywords.'SecuredProfile.defineSecuredProfiles'(aProfileOnDesktop) // "C:/Users/my.name/Desktop/secured_production_profile.glbl"
